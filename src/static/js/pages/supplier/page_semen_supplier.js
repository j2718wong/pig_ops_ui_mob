...
<div class="form-container">
    ...
    <div class="modal-header">
        <h5 class="modal-title">
            <span id="${elemIdHeaderTitle}"><i class="fas fa-plus me-2"></i>Add Semen Supplier</span>
        </h5>
    ...
    <div class="modal-body">
		...
		<div class="form-group-select">
            ...
            <select class="form-select" id="${elemIdAddressLevel1}" required>
		...
		<div class="form-group-select">
            ...
            <select class="form-select" id="${elemIdAddressLevel2}" required>
				<option value="0" selected disabled>Please Select</option>
            </select>
        </div>
		...
		<div class="form-group-select">
            ...
            <select class="form-select" id="${elemIdAddressLevel3}" required>
				<option value="0" selected disabled>Please Select</option>
            </select>
        </div>
		...
		<!-- 4. Entry Select -->
		<div class="form-group-select">
            <label for="${elemIdAdrsItemSelect}" class="form-label">
                Select Entry <span class="entries-count" id=${elemIdEntryCount}></span>
            </label>
                        
            <div class="input-group" id="sowSelectGroup">
                <select class="form-select" id="${elemIdAdrsItemSelect}">
