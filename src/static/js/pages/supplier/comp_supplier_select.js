...
export function ComponentSupplierSelect(input_settings){
    UiBasic.call(this);
    ...
    */
    ...
    this._bindEventListeners = function(){
        ...
        elemEntryAdd.addEventListener('click', function() {
            ...
            const options_supplier ={
                is_add:         true,
                supplier_type:  settings.supplierType,
    ...
    this.setValue = function(supplier_hid){
        elemSelect.value = supplier_hid;
    }
    ...
    this.setDataSupplierList = function(data){
        ...
        if (settings.supplierType == SUPPLIER_TYPE.SEMEN){
            // Show this already
    ...
    this.beforeShow = function(){
        let account_suppliers = null;
        
        switch (settings.supplierType){
            case SUPPLIER_TYPE.FEED: {
                account_suppliers = navigation.pigFarm.accountLists.dataFeedSupplierList;
                break;
            }
            case SUPPLIER_TYPE.SEMEN: {
                account_suppliers = navigation.pigFarm.accountLists.dataSemenSupplierList;
                break;
            }
            case SUPPLIER_TYPE.GILT: {
                account_suppliers = navigation.pigFarm.accountLists.dataGiltSupplierList;
                break;
            }
        }
        ...
        if (account_suppliers == null){
            ...
            thisObj.setDataSupplierList(account_suppliers);
        }
    }
    
   
    this.populateSupplierDetails = function(supplier_hid){
        const cur_supplier = this.getDataSupplier(supplier_hid);
    ...
    this.onChangeSupplier = function(semen_type_hid){
        elemSelect.classList.remove('is-valid', 'is-invalid');
    ...
    this.getDataSupplier = function(supplier_hid){
